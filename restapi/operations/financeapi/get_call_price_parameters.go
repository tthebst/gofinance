...
func NewGetCallPriceParams() GetCallPriceParams {

	return GetCallPriceParams{}
}
...
//
// To ensure default values, the struct must have been initialized with NewGetCallPriceParams() beforehand.
func (o *GetCallPriceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
